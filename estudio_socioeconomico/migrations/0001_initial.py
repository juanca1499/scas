...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('usuarios', '0002_alter_usuario_dado_baja'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credencial', models.FileField(upload_to='estudio/ine/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['png', 'jpeg', 'jpg', 'pdf'], message='Sólo se permiten imágenes PNG, JPG, JPEG o PDF.')], verbose_name='Credencial INE/IFE')),
                ('comprobante_domicilio', models.FileField(upload_to='estudio/comprobante/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['png', 'jpeg', 'jpg', 'pdf'], message='Sólo se permiten imágenes PNG, JPG, JPEG o PDF.')], verbose_name='Comprobante de domicilio')),
                ('edad', models.PositiveIntegerField(blank=True, validators=[django.core.validators.MinValueValidator(1)], verbose_name='Edad')),
                ('calle', models.CharField(max_length=40, verbose_name='Calle')),
                ('numero_exterior', models.PositiveIntegerField(blank=True, validators=[django.core.validators.MinValueValidator(1)], verbose_name='Número exterior')),
                ('numero_interior', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1)], verbose_name='Número interior')),
                ...
                ('cabeza_familia', models.BooleanField(default=False, verbose_name='Es cabeza de familia')),
                ...
                ('numero_recamaras', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(0)], verbose_name='Número de recamaras')),
                ('numero_banios', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(0)], verbose_name='Número de baños')),
                ('otros_caracteristicas_casa', models.CharField(blank=True, max_length=60, null=True, verbose_name='Otro')),
                ...
                ('enfermedad_cardiopatias', models.BooleanField(default=False, verbose_name='Cardiopatías')),
                ...
                ('enfermedad_otro', models.CharField(blank=True, max_length=60, null=True, verbose_name='Otro (Especifique)')),
                ('receta', models.FileField(blank=True, null=True, upload_to=' estudio/receta/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['png', 'jpeg', 'jpg', 'pdf'], message='Sólo se permiten imágenes PNG, JPG, JPEG o PDF.')], verbose_name='Receta en caso de ser necesario')),
                ...
                ('servicio_salud', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='estudio_socioeconomico.serviciosalud', verbose_name='Servicio de salud')),
