...
def step_impl(context, solicitud):
    path = '/html/body/div/div/div[1]/div/div[2]/div/div[2]/div/div[2]/table/tbody/tr[' + \
        solicitud + ']/td[9]/a[1]'
...
def step_impl(context, path):
    ...
    context.driver.find_element_by_id(
        'id_comprobante_domicilio').send_keys(archivo)
...
def step_impl(context, numero_exterior):
    context.driver.find_element_by_id(
        'id_numero_exterior').send_keys(numero_exterior)
...
def step_impl(context, numero_recamaras):
    context.driver.find_element_by_id(
        'id_numero_recamaras').send_keys(numero_recamaras)


@given(u'capturo el numero de baños "{numero_banios}"')
def step_impl(context, numero_banios):
    context.driver.find_element_by_id(
        'id_numero_banios').send_keys(numero_banios)
