...
class Solicitud(models.Model):
    ...
    resumen = models.TextField(
        'Resumen de la solicitud', blank=True, null=True)
    estatus = models.ForeignKey(
        EstatusSolicitud, verbose_name='Estatus de la solicitud', on_delete=models.CASCADE)
    usuario = models.ForeignKey(
        "usuarios.Usuario", verbose_name='Usuario', on_delete=models.CASCADE)
